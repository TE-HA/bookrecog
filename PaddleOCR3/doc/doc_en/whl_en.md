...
img_path = 'PaddleOCR4/doc/imgs_en/img_12.jpg'
...
im_show = draw_ocr(image, boxes, txts, scores, font_path='/path/to/PaddleOCR4/doc/simfang.ttf')
...
img_path = 'PaddleOCR4/doc/imgs_words_en/word_10.png'
...
image = Image.open(img_path).convert('RGB')
im_show = draw_ocr(image, result, txts=None, scores=None, font_path='/path/to/PaddleOCR4/doc/simfang.ttf')
im_show = Image.fromarray(im_show)
im_show.save('result.jpg')
```
