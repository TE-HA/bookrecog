...
def main(no_bbox, thickness, bbox_color, text_color, warn_text_color, font_scale, warn_font_scale, cmap, ignore_color,
         inst_border_size, blend_alpha, show, jobs, semseg, rescale, ann_file, img_dir, out_dir):
    if show:
        jobs = 1
