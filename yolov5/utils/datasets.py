...
# import albumentations as A_augment
import cv2
import numpy as np
import torch
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if self.augment and random.random() < hyp['salt']:
            # TODO: salt
...
def get_dt_box(dt_boxes):
    result_list = []
    for dt_box in dt_boxes:
        xmin, ymin, xmax, ymax = int(dt_box[1]-100), int(dt_box[2]-100), int(dt_box[3]+100), int(dt_box[4]+100),
